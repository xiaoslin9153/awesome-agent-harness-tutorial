...
| --- | --- | --- | --- | --- | --- | --- | --- |
| C-01 | [Agent、Harness 与 Runtime 的边界](./01-core-concepts/agent-vs-harness.md) | `01-core-concepts/agent-vs-harness.md` | 无 | 为什么一个会调用模型的循环仍不能称为完整 Agent 系统？ | 决策能力与受控执行能力的边界；Harness 必须拥有可审计的控制面。 | 谁启动、暂停、恢复和终止一次 Run？ | ✅ 已完成 |
