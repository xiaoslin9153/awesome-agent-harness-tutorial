...
1. 完成 G11 / G12 的站点图渲染验证。
2. K03：撰写《一次 Agent Run 的完整生命周期》。
3. F00：建立 C01-C25 证据索引模板。
4. FR02 / FD02 / FP02：横向定位三家 Run 生命周期。
5. FR03 / FD03 / FP03：横向定位三家状态模型。
6. S01：在第一篇教材稳定后做站点选型。
